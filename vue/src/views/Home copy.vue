<template>
  ...
  <div class="top-content"> 
    ...
    <div class="header-banner">
      <img src="@/assets/images/backgrounds/indexpageback.png" alt="首页背景" class="banner-image" />
    </div>

    <!-- 主横幅 -->
    <div class="main-banner">
      <img src="@/assets/images/backgrounds/banner.png" alt="主横幅" class="main-banner-image" />
    </div>
    ...
    <div class="news-section">
      <div class="section-header">
        <img src="@/assets/icons/png/news.png" alt="新闻中心" class="news-title-icon" />
      ...
      <div class="news-list">
        ...
        >
          <div class="news-thumb">
            <img :src="newsImg" alt="新闻图片" class="thumb-image" />
          </div>
          <div class="news-content">
            <div class="news-text">
              党的建设是党的工作的属概念,又是党务工作的种概念,它是指党...
            </div>
            <div class="news-footer">
              <div class="news-tag">二重二新</div>
              <div class="news-date">2019-06-18</div>
            </div>
          </div>
        </div>
      </div>
