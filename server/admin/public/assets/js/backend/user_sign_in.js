define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user_sign_in/index' + location.search,
                    add_url: 'user_sign_in/add',
                    edit_url: 'user_sign_in/edit',
                    del_url: 'user_sign_in/del',
                    multi_url: 'user_sign_in/multi',
                    import_url: 'user_sign_in/import',
                    table: 'user_sign_in',
                }
            });
