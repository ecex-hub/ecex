...
<div class="system-message {$codeText}">
    ...
    {/if}
    <p class="clearfix">
        <a href="{$url|htmlentities}" class="btn btn-grey">{:__('Go back')}</a>
        {if $url}
