...
/**
 * ContactForm is the model behind the contact form.  福利二投资注入总金额
 */
class WelfareRebateMoney extends BaseModel {

    protected $table = 't_welfare_rebate_money';

    public static function tableName() {
        return '{{t_welfare_rebate_money}}';
    }
...
//            ['utime', 'number'], //
     ...
     * @return boolean
     */
    public static function AddWelfareRebateMoney($buyMoney) {
        $where = [
            'and'
        ];
     ...
     * @return int
     */
    public static function getWelfareRebateMoney() {
        $where = [
            'and'
        ];
     ...
     * @return type
     */
    public function getClientWelfareRebateMoneyMessage() {
        $rediskey = __METHOD__;
