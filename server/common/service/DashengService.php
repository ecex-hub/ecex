...
class DashengService
{

    const secret_key = "HLWCGPTOW1PG39H0MQGBXB4VLQCJ42ID1WCUTIG6JX6H00JCWPEKRWQWFOGFD1F9RJ9EFMUQM2NOVLOHREHVPCZYJEQBWTAFRALTJGXPX6JXXUE8O0HJEWV5R9KJH0EJ";
    const mchId = "10018";
    const payOrderUrl = "http://pay.dshpal.cfd/api/pay/create_order";
    ...
    public function payOrder($data)
    {
        ...
        $notify = \Yii::$app->params['base_url']."/callback/dasheng";
