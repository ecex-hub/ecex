...
class YunsifangService
{
    const secret_key = "5FSIJD5CNNTJCBKZQZ4EB3TZJOOGOGRTFKPDVS84UWP7VT2NEXODCSPERXSU1FBVRDGXMBYPB6KU209YMGZII1HK6QCGYKRNMDPE2LBHYHZTC17DA4PBTDIHEIKREEPC";
    const mchId = "880123110630";
    const appId = "fcbf087d65c64826bc814130ab83cd65";
    const payOrderUrl = "https://pay.yysf.app/api/payAPI/create";
    ...
    {
        $notify = \Yii::$app->params['base_url']."/callback/yunsifang";
    ...
    public function callback($data)
    {
        ...
        if (!isset($data['sign'])) {
            FuncHelper::ErrLog('pay_callback_yunsifang', [
            ], "empty sign");
            return false;
        }
        if ($sign != $data['sign']) {
